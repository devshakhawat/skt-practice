( function( wp, React, $ ) {
    ...
    const BlockDisplay = function({ setAttributes, attributes, className }) {
        ...
        return <div className='skt--block'>
            <ServerSideRender className={className} block='sktprac/shortcodeform' attributes={ attributes } />
        </div>
    }
    ...
    registerBlockType('sktprac/shortcodeform', {

        title: __( 'User Form', 'skt' ),
        description: __( 'Show User Form to Submit Data', 'skt' ),
        icon: Icon,
        category: 'layout',
